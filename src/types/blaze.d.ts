...
import core from '../../example/services/core';
import users from '../../example/services/users';
...
declare module '@busy-hour/blaze' {
  ...
  export interface TrpcQueryCallRecord
    extends TrpcQueryExtractor<typeof core>,
      TrpcQueryExtractor<typeof users> {}

  export interface TrpcMutationCallRecord
    extends TrpcMutationExtractor<typeof core>,
